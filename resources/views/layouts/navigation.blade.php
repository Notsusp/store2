...
>
    ...
    <!-- Responsive Menu -->
    <div class="w-500 text-white flex gap-2 items-center p-3 pb-0" x-data="{
    ...
    <form action="" method="GET" class="" @submit.prevent="updateUrl">
            <x-input class="text-black" type="text" name="search" placeholder="Search for products"
                     x-model="searchKeyword"/>
        </form>
    <div
        class="block fixed z-10 top-0 bottom-0 height h-full w-[220px] transition-all bg-white-900 md:hidden"
              ...
              <span class="flex items-center">
                ...
                My Account
                    ...
                    <ul
                        x-show="open"
                        x-transition
                        class="z-10 right-0 bg-#FFFFFF py-2"
                    >
                        <li>
                            <a href="{{ route('profile') }}" class="flex px-3 py-2 hover:bg-white-900">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 mr-2"
                                    fill="none"
    ...
    <nav class="hidden md:block">
        <ul class="grid grid-flow-col items-center">
            <li>
                <a
                    href="{{ route('cart.index') }}"
                    class="relative inline-flex no-underline hover:text-white hover:underline py-2 px-4"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-5 w-5 mr-2"
            ...
            @if (!Auth::guest())
                <li x-data="{open: false}" class="relative">
                    <a
                        @click="open = !open"
                        class="cursor-pointer flex items-center py-navbar-item px-navbar-item pr-5 hover:underline"
                    >
              <span class="flex items-center">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                My Account
                    ...
                    >
                        <li>
                            <a
                                href="{{ route('profile') }}"
                                class="flex px-3 py-2 hover:underline"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="h-5 w-5 mr-2"
            ...
            @else
                <li>
                    <a
                        href="{{ route('login') }}"
                        class="flex items-center py-navbar-item px-navbar-item hover:underline"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 mr-2"
