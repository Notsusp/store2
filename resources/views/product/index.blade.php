...
<x-app-layout>
    ...
    <div class="flex gap-2 items-center p-3 pb-0" x-data="{
        ...
        <x-input
            ...
            type="select"
            name="sort"
            class="w-full focus:border-yellow-500 focus:ring-yellow-500 border-gray-300 rounded">
    ...
    <?php else: ?>
    <div
        class="grid gap-3 grig-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 p-3"
    >
            ...
            <div
                ...
                >
                    ...
                    <div class="p-4">
                        ...
                        <h5 class="font-bold">{{$product->price}} Lei</h5>
                    </div>
